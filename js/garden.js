...
Bloom.prototype = {
    draw: function() {
        ...
        // Draw the text "Sushma" below the bloom
        this.garden.ctx.font = "20px Arial";
        this.garden.ctx.textAlign = "center";
        this.garden.ctx.fillStyle = this.c;
        this.garden.ctx.fillText("Sushma", 0, this.r + 20); // Position the text below the flower
